  ...
  <nav class="navbar navbar-expand-md navbar-primary bg-dark fixed-top">
    <div class="container-fluid px-3">
      ...
      <div id="navbarDefault" :class="['collapse navbar-collapse', navbarExpanded && 'show']">
        ...
        <ul class="navbar-nav float-right d-none d-md-block">
        ...
        <div class="d-block d-md-none d-flex justify-content-between py-4">
          <button type="button" class="btn text-white btn-light">
            Connect
          </button>
